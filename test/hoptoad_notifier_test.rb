...
class HoptoadNotifierTest < Test::Unit::TestCase
  ...
  context "Hoptoad inclusion" do
    ...
    should "be able to occur inside Rails controllers" do    
      assert_nothing_raised do
        class MyHoptoadController
          def rescue_action_in_public
          end
          include HoptoadNotifier::Catcher
        end
      end
      my = MyHoptoadController.new
      assert my.respond_to?(:rescue_action_in_public_with_hoptoad)
    end
  end
